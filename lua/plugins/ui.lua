...
if ok_wk then
  ...
  wk.add({
    ...
    { "<leader>f", group = "file", icon = { icon = "󰈞 ", color = "cyan" } },
    { "<leader>s", group = "search", icon = { icon = " ", color = "green" } },
    { "<leader>g", group = "git", icon = { icon = " ", color = "orange" } },
    { "<leader>h", group = "hunks", icon = { icon = " ", color = "orange" } },
    { "<leader>c", group = "code", icon = { icon = " ", color = "orange" } },
    { "<leader>l", group = "pack/lazy", icon = { icon = "󰏗 ", color = "purple" } },
    { "<leader>u", group = "ui/toggle", icon = { icon = " ", color = "yellow" } },
    { "<leader>e", group = "explorer", icon = { icon = "󰙅 ", color = "cyan" } },
    { "<leader>m", group = "marks/grapple", icon = { icon = "󰛢 ", color = "azure" } },
    { "<leader>q", group = "quit/session", icon = { icon = "󰈆 ", color = "red" } },
    { "<leader><Tab>", group = "tab", icon = { icon = "󰓩 ", color = "purple" } },
    { "<leader>-", icon = { icon = " ", color = "blue" } },
    { "<leader>|", icon = { icon = " ", color = "blue" } },
    { "<leader>`", icon = { icon = "󰈔 ", color = "cyan" } },
    { "<leader>:", icon = { icon = " ", color = "grey" } },
    { "<leader>1", icon = { icon = "󰛢 ", color = "azure" } },
    { "<leader>2", icon = { icon = "󰛢 ", color = "azure" } },
    { "<leader>3", icon = { icon = "󰛢 ", color = "azure" } },
    { "<leader>4", icon = { icon = "󰛢 ", color = "azure" } },
    { "<leader>E", icon = { icon = "󰙅 ", color = "cyan" } },
    { "<leader>M", icon = { icon = "󰛢 ", color = "azure" } },
  })
end
