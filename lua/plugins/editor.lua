...
-- ---------- neominimap: side overview with search/diagnostic/git highlights ---
map("n", "<leader>um", "<cmd>Neominimap Toggle<cr>", { desc = "Toggle Minimap" })
map("n", "<leader>uM", "<cmd>Neominimap ToggleFocus<cr>", { desc = "Focus Minimap" })
map("n", "<leader>uR", "<cmd>Neominimap Refresh<cr>", { desc = "Refresh Minimap" })
